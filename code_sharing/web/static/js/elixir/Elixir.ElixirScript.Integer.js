    ...
    const is_even = Elixir.Core.Patterns.defmatch(Elixir.Core.Patterns.clause([Elixir.Core.Patterns.variable()],function(number)    {
        return     number % 2 == 0;
      }));
    const parse = Elixir.Core.Patterns.defmatch(Elixir.Core.Patterns.clause([Elixir.Core.Patterns.variable()],function(bin)    {
        ...
        return     Elixir.Core.Patterns.defmatch(Elixir.Core.Patterns.clause([Elixir.Core.Patterns.variable()],function(index_of_dot)    {
        return     new Elixir.Core.Tuple(result,'');
      },function(index_of_dot)    {
        return     index_of_dot < 0;
      }),Elixir.Core.Patterns.clause([Elixir.Core.Patterns.variable()],function(index_of_dot)    {
    ...
    const is_odd = Elixir.Core.Patterns.defmatch(Elixir.Core.Patterns.clause([Elixir.Core.Patterns.variable()],function(number)    {
        return     number % 2 != 0;
      }));
    const to_char_list = Elixir.Core.Patterns.defmatch(Elixir.Core.Patterns.clause([Elixir.Core.Patterns.variable()],function(number)    {
        return     to_char_list(number,10);
      }),Elixir.Core.Patterns.clause([Elixir.Core.Patterns.variable(), Elixir.Core.Patterns.variable()],function(number,base)    {
